...
export type MessageItemFragment = { __typename?: 'Message', id: string, content: string, createdAt: string, sender: { __typename?: 'User', id: string, name: string, username: string, avatar: string } } & { ' $fragmentName'?: 'MessageItemFragment' };
